...
3. **Ajouter les variables suivantes**
   ...
   **Variable 1 : DATABASE_URL**
   ```
   Nom: DATABASE_URL
   Valeur: postgresql://neondb_owner:npg_lFSMK9NPwO0m@ep-wandering-glitter-ag8ef98y-pooler.c-2.eu-central-1.aws.neon.tech/neondb?channel_binding=require&sslmode=require
   ...
   **Variable 2 : SESSION_SECRET**
   ```
   Nom: SESSION_SECRET
   Valeur: efe96c3c85d624d20c5981f41050105010771d8375ca7e913abc3cea6d67ba4d
   Environnements: Production, Preview, Development (cocher les 3)
   ```
...
```
postgresql://neondb_owner:npg_lFSMK9NPwO0m@ep-wandering-glitter-ag8ef98y-pooler.c-2.eu-central-1.aws.neon.tech/neondb?channel_binding=require&sslmode=require
```
