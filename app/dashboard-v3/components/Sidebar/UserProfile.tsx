    ...
    <div className="bg-zinc-800 rounded-xl p-3 border border-zinc-700">
      <div className="flex items-center gap-3">
        ...
        <div className="relative flex-shrink-0">
          <div className="w-12 h-12 rounded-full bg-gradient-to-br from-blue-600 to-emerald-600 flex items-center justify-center text-white font-bold text-sm">
            {initials}
          </div>
          {/* Indicateur en ligne */}
        ...
        <div className="flex-1 min-w-0">
          ...
          {/* Badge streak */}
          <div
            className="relative inline-flex items-center gap-1.5 mt-1 px-3 py-1.5 min-h-[36px] bg-gradient-to-r from-orange-600 to-red-600 rounded-md cursor-pointer"
          ...
          >
            ...
            {showRecord && (
              <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-1.5 bg-zinc-900 border border-zinc-700 rounded-lg whitespace-nowrap animate-[fadeIn_0.2s_ease-out]">
