...
export default function PublicDecksV1() {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6">
          <input
            ...
            className="w-full px-4 py-2 border border-zinc-800 rounded-md bg-zinc-900 text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
        </div>
              ...
              <div className="flex flex-col h-full">
                ...
                <div className="mt-auto">
                  {deck.isImported ? (
                    <button
                      disabled
                      className="w-full px-4 py-2 bg-green-900/20 text-green-400 rounded-md cursor-not-allowed"
                    >
                      ✓ Déjà importé
                    </button>
                  ) : (
                    <button
                      ...
                      className="w-full px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 disabled:bg-zinc-700 disabled:cursor-not-allowed transition-colors"
                    >
