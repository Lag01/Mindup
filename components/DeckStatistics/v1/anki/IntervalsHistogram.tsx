...
const BUCKETS: Array<{ key: keyof IntervalsHistogramProps['data']; label: string; color: string }> = [
  { key: 'i1', label: '1 jour', color: CHART_COLORS.danger },
  { key: 'i7', label: '2–7 j', color: CHART_COLORS.warning },
  { key: 'i30', label: '8–30 j', color: CHART_COLORS.caution },
  { key: 'i90', label: '1–3 mois', color: CHART_COLORS.success },
  { key: 'i180', label: '3–6 mois', color: CHART_COLORS.info },
  { key: 'iMax', label: '> 6 mois', color: CHART_COLORS.accent },
];
