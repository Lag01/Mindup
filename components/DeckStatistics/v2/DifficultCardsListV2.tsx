              ...
              <div className="flex gap-4 p-4 pl-5">
                ...
                <div className="flex-1 space-y-4">
                  ...
                  <button
                    ...
                    className="rounded-lg bg-zinc-800/60 px-4 py-1.5 text-xs font-bold uppercase tracking-wide text-zinc-300 transition-all hover:bg-zinc-700 hover:text-white"
