...
export function DistributionTabs({ ratingDistribution }: DistributionTabsProps) {
  ...
  return (
    <Tabs defaultValue="ratings" className="w-full">
      <TabsList className="grid w-full grid-cols-2 bg-zinc-900/50 border border-zinc-700/50">
      ...
      <TabsContent value="ratings" className="mt-6 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          {ratingData.map((rating, index) => (
            <div
              key={rating.name}
              className="group relative overflow-hidden rounded-lg border border-zinc-700/50 bg-zinc-900/50 p-4 transition-all hover:border-zinc-600/70 backdrop-blur-sm"
              style={{
      ...
      <TabsContent value="details" className="mt-6 space-y-4">
        <div className="overflow-hidden rounded-lg border border-zinc-700/50 bg-zinc-900/50 backdrop-blur-sm">
          {/* Stats Grid */}
