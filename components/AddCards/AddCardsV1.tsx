...
export default function AddCardsV1() {
        ...
        <div className="max-w-3xl mx-auto">
          <div className="flex flex-col sm:flex-row gap-2">
            ...
            <button
              ...
              className="w-full sm:flex-1 bg-green-600 hover:bg-green-700 text-white font-medium px-4 py-3 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm flex items-center justify-center gap-2 order-1 sm:order-2"
            >
