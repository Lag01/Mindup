            ...
            <div className="bg-zinc-800/40 border border-zinc-700/50 rounded-xl p-4 space-y-3">
              ...
              <label className="flex items-start gap-3 cursor-pointer">
                <input
                  ...
                  className="mt-1 h-4 w-4 border-zinc-600 bg-zinc-900 text-cyan-500 focus:ring-cyan-500 focus:ring-offset-zinc-900"
                />
                <div>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {destination === 'append' && canAppend && userDecks.length > 0 && (
                    <select
                      ...
                      className="mt-2 w-full bg-zinc-900/80 border border-zinc-700/50 text-zinc-200 text-sm rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-500/50"
                    >
                      {userDecks.map((d) => (
